...
The goal of this document is to provide some basic performance testing of the
...
call stack to a file. This information can be used to attribute a portion of
run time to each function called.
